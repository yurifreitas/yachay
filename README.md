...
**The atlas, which is the larger half.** 61 tools, 38 registered pipeline stages, 37 artefacts
...
| `tools/README.md` | the 61 scripts grouped by purpose: ingest, catalogue, patient, gene, self-audit, authored, statistics |
