...
**The atlas, which is the larger half.** 58 tools, 36 registered pipeline stages, 35 artefacts
...
| `tools/README.md` | the 58 scripts grouped by purpose: ingest, catalogue, patient, gene, self-audit, authored, statistics |
