...
**The atlas, which is the larger half.** 65 tools, 43 registered pipeline stages, 41 artefacts
...
| `tools/README.md` | the 65 scripts grouped by purpose: ingest, catalogue, patient, gene, self-audit, authored, statistics |
