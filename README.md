...
**The atlas, which is the larger half.** 64 tools, 41 registered pipeline stages, 40 artefacts
...
| `tools/README.md` | the 64 scripts grouped by purpose: ingest, catalogue, patient, gene, self-audit, authored, statistics |
